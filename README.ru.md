...
- `sample_rate` - определяет частоту дискретизации распознаваемого аудиофайла. Доступность частоты распознавания ограничена выбранной моделью Vosk. Для `vosk-model-small-ru-0.22` рекомендуется распознавать аудио с частотой 16000(Гц).
...
При использовании собственного аудиофайла убедитесь, что он имеет правильный формат - PCM S16LE mono (и частоту 16000Гц).
